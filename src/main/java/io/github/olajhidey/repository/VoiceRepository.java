...
import io.github.olajhidey.endpoints.VoiceInterface;
...
public class VoiceRepository implements VoiceInterface {
     ...
     */
    @Override
    public io.github.olajhidey.model.call.Call create(String from,
                                                      String to,
                                                      String url,
                                                      Boolean record,
        ...
        try {
            ...
            return gson.fromJson(response, io.github.olajhidey.model.call.Call.class);
     ...
     */
    @Override
    public io.github.olajhidey.model.call.Call get(String sid) {
        ...
        try {
            ...
            return gson.fromJson(body, io.github.olajhidey.model.call.Call.class);
     ...
     */
    @Override
    public io.github.olajhidey.model.call.Call update(String sid, String url, String fallbackUrl, String status, String statusCallBack) {
